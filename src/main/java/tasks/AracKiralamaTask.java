...
public class AracKiralamaTask {
    ...
    ***********  Araba Kiralama Projesi TASK   ***********
        ...
        *
        *
        -	alınacaksehir, alınacakgun, alıssaati, teslimGunu, teslimSaati
        ...
        *
        -	Tum variable’lar için Getter ve Setter method’ları oluşturun (Encapsulation).
             ...
             *
             *
        -	aracTalep() adında bir method oluşturunuz.Bu method’da alinacak sehir, teslim edilecek
            sehir, alinacak gun ve teslim edilecek gun ve teslim saati bilgilerini aliniz.
         	...
         	*
         	*
        -	arabalar() create ederek, tüm araç modellerini bir list’e atınız. (parametre olarak
            araç ile bilgileri alan <marka, model, yakıt tipi, vites, gunlukUcret> objeleri
            list’e atınız.)        Bu list’i göstererek bir aracı kiralamasını sağlayın.
        ...
        -	musteriBilgileri() metodu ile müşteri ile ilgili bilgileri aliniz. AdSoyad, ID, yaş
             ve telefon.
