...
import java_core.day10_switchloops.Switch01;
...
public class LoginRunner {
    ...
    email validation: boşluk içermemeli
                         ...
                         : mailin kullanıcı adı kısmında(@ den önce) sadece büyük-küçük harf,rakam yada
...
public static void start() {
     ...
     do {
          ...
          switch (select){
               ...
               default:
                    System.out.println("Hatali Giris  Yaotiniz. Yeniden Deneyiniz.");
