...
ArrayList02 {
    public static void main(String[] args) {
      ...
      Ama sol tarafa ister "ArrayList" yazin isterseniz de "List" yazin,ikisi de calisir.
        ...
        */
//Array'i nasıl yazdırırsın, List'i nasıl yazdırırsın? buna da dikkat edin arkadaslar
        List<Character> initials = new ArrayList<>();
        initials.add('A');
        initials.add('B');
        initials.add('M');
...
//Example 1: Verilen bir String List'teki elemanlarin toplam karakter sayisini
// bulan kodu yaziniz.
