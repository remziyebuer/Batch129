package java_core.day23_datetime_stringbuilder;

/*

  Java da String , "String Class"  kullaninarak veya "StringBuilder Class"
 kullanilarak olusturulabilir."String Class" kullanilarak urettiginiz String'ler
 "Immutable"( degistirelemez) dir."StringBuilder Class" kullanarak urettiginiz
 String'ler "Mutable"(Degistirelebilir) dir.
...
//Immutable
        ...
        System.out.println(sb2.capacity());//34*2+2 ==> 7034*2+2
