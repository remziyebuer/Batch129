package advanced._practice.practice04;

import java.util.Scanner;

public class ForEach_Sifreleme {
    public static void main(String[] args) {
        /*  Kullanıcıdan alınan bir String'de bulunan her bir karakteri alfabetik
            sırada bir sonraki karakter ile değiştirerek
