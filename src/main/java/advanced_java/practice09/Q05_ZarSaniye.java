...
public class Q05_ZarSaniye {
    ...
    //Zarın atıldığı saniye 5'in katı ise zar sayısı 5 ile çarpılıp puana
    // eklenecek, çiftse zar sayısı iki ile çarpılıp puana eklenecek,tekse
    // zar sayısı puana eklenecek.
