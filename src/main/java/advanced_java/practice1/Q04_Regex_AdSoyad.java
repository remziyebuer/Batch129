...
//Array in kac elementi oldugunu length ile mi bakacaz diye sordum eger iki isimden fazla ise
// evet  sonra da if ile yaparsin dedi hoca ve bir arkadas bu kodla length  olur dedi
// dersten sonra dene

        int  bb = adSoyad.split(" ").length;
