package ogrencikodlari;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;

public class AlisverisIlkerBey {
    ...
    public static void basket(){
        ...
        List<String> ggProducts = new ArrayList<>(AlisverisIlkerBey.grgProducts());
        List<Double> ggPrices = new ArrayList<>(AlisverisIlkerBey.prices());
        do {
